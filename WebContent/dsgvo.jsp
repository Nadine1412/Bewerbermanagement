...
<p><strong><big>Datenschutzerklaerung</big></strong></p>
<p><strong>Allgemeiner Hinweis und Pflichtinformationen</strong></p>
<p><strong>Benennung der verantwortlichen Stelle</strong></p>
<p>Die verantwortliche Stelle fuer die Datenverarbeitung auf dieser Website ist:</p>
<p><span id="s3-t-firma">Hochschule Furtwangen</span><br><span id="s3-t-ansprechpartner">Max Mustermann</span><br><span id="s3-t-strasse">Robert-Gerwig-Platz 1</span><br><span id="s3-t-plz">78120</span> <span id="s3-t-ort">Furtwangen</span></p><p></p>
<p>Die verantwortliche Stelle entscheidet allein oder gemeinsam mit anderen ueber die Zwecke und Mittel der Verarbeitung von personenbezogenen Daten (z.B. Namen, Kontaktdaten o. ae.).</p>

<p><strong>Widerruf Ihrer Einwilligung zur Datenverarbeitung</strong></p>
<p>Nur mit Ihrer ausdruecklichen Einwilligung sind einige Vorgaenge der Datenverarbeitung moeglich. Ein Widerruf Ihrer bereits erteilten Einwilligung ist jederzeit moeglich. Fuer den Widerruf genuegt eine formlose Mitteilung per E-Mail. Die Rechtmaessigkeit der bis zum Widerruf erfolgten Datenverarbeitung bleibt vom Widerruf unberuehrt.</p>

<p><strong>Recht auf Beschwerde bei der zustaendigen Aufsichtsbehoerde</strong></p>
<p>Als Betroffener steht Ihnen im Falle eines datenschutzrechtlichen Verstosses ein Beschwerderecht bei der zustaendigen Aufsichtsbehoerde zu. Zustaendige Aufsichtsbehoerde bezueglich datenschutzrechtlicher Fragen ist der Landesdatenschutzbeauftragte des Bundeslandes, in dem sich der Sitz unseres Unternehmens befindet. Der folgende Link stellt eine Liste der Datenschutzbeauftragten sowie deren Kontaktdaten bereit: <a href="https://www.bfdi.bund.de/DE/Infothek/Anschriften_Links/anschriften_links-node.html" target="_blank">https://www.bfdi.bund.de/DE/Infothek/Anschriften_Links/anschriften_links-node.html</a>.</p>

<p><strong>Recht auf Datenuebertragbarkeit</strong></p>
<p>Ihnen steht das Recht zu, Daten, die wir auf Grundlage Ihrer Einwilligung oder in Erfuellung eines Vertrags automatisiert verarbeiten, an sich oder an Dritte aushaendigen zu lassen. Die Bereitstellung erfolgt in einem maschinenlesbaren Format. Sofern Sie die direkte uebertragung der Daten an einen anderen Verantwortlichen verlangen, erfolgt dies nur, soweit es technisch machbar ist.</p>

<p><strong>Recht auf Auskunft, Berichtigung, Sperrung, Loeschung</strong></p>
<p>Sie haben jederzeit im Rahmen der geltenden gesetzlichen Bestimmungen das Recht auf unentgeltliche Auskunft ueber Ihre gespeicherten personenbezogenen Daten, Herkunft der Daten, deren Empfaenger und den Zweck der Datenverarbeitung und ggf. ein Recht auf Berichtigung, Sperrung oder Loeschung dieser Daten. Diesbezueglich und auch zu weiteren Fragen zum Thema personenbezogene Daten koennen Sie sich jederzeit ueber die im Impressum aufgefuehrten Kontaktmoeglichkeiten an uns wenden.</p>
...
<p>Zur Nutzung bestimmter Funktionen koennen Sie sich auf unserer Website registrieren. Die uebermittelten Daten dienen ausschliesslich zum Zwecke der Nutzung des jeweiligen Angebotes oder Dienstes. Bei der Registrierung abgefragte Pflichtangaben sind vollstaendig anzugeben. Andernfalls werden wir die Registrierung ablehnen.</p>
<p>Im Falle wichtiger aenderungen, etwa aus technischen Gruenden, informieren wir Sie per E-Mail. Die E-Mail wird an die Adresse versendet, die bei der Registrierung angegeben wurde.</p>
...
<p>Mit einem modernen Webbrowser koennen Sie das Setzen von Cookies ueberwachen, einschraenken oder unterbinden. Viele Webbrowser lassen sich so konfigurieren, dass Cookies mit dem Schliessen des Programms von selbst geloescht werden. Die Deaktivierung von Cookies
	kann eine eingeschraenkte Funktionalitaet unserer Website zur Folge haben.</p>
<p>Das Setzen von Cookies, die zur Ausuebung elektronischer Kommunikationsvorgaenge oder der Bereitstellung bestimmter, von Ihnen erwuenschter Funktionen (z.B. Warenkorb) notwendig sind, erfolgt auf Grundlage von Art. 6 Abs. 1 lit. f DSGVO. Als Betreiber dieser
	Website haben wir ein berechtigtes Interesse an der Speicherung von Cookies zur technisch fehlerfreien und reibungslosen Bereitstellung unserer Dienste. Sofern die Setzung anderer Cookies (z.B. fuer Analyse-Funktionen) erfolgt, werden diese in dieser
	Datenschutzerklaerung separat behandelt.</p>
