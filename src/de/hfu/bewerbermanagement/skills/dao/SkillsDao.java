			...
			if (statementUpdateSkills != null) {
				try {
					int counterSkill = jdbcTemplate.update(statementUpdateSkills, new Object[] {
							skills.getProgrammingLanguage().contains("Java"),
							skills.getProgrammingLanguage().contains("JavaScript"),
							skills.getProgrammingLanguage().contains("C++"),
							skills.getProgrammingLanguage().contains("Python"),
